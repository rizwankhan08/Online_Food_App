...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;text-align:center">
    <div>
        ...
        <h1 style="font-size:4rem;font-weight:800;color:var(--danger)">500</h1>
        <h2 style="margin-bottom:8px">Something went wrong</h2>
        <p style="color:var(--text-secondary);margin-bottom:24px">We're working on fixing this. Please try again later.</p>
